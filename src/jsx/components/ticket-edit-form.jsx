  ...
  validate(field, value) {
    ...
    switch (field) {
      case 'name':
        ...
        break;
      case 'message':
        validation.message.valid = value.length > 0;
        break;
    }
            ...
            <form className="form-horizontal" action="/" onSubmit={this.props.submit}>
              <div className="form-group">
                ...
                <div className="col-sm-9">
                  <input type="text" className="form-control" id="name" name="name" value={this.props.ticket.name} placeholder="Ticket Name" onChange={this.changeInput} />
                </div>
              </div>
              <div className="form-group">
                <label className="col-sm-3 control-label" htmlFor="message">Message</label>
                <div className="col-sm-9">
                  <input type="text" className="form-control" id="message" name="message" value={this.props.ticket.message} placeholder="Message" onChange={this.changeInput} />
                </div>
              </div>
              <div className="form-group">
